...
public class RoleMenuCommand implements Command {
        ...
        static {
            path.put(AbstractAppUser.Role.ADMINISTRATOR.toString(), JspPath.ADMINISTRATOR_MENU_PAGE);
            path.put(AbstractAppUser.Role.USER.toString(), JspPath.USER_MENU_PAGE);
        }
