...
public class InputChecker {
    ...
    public static boolean checkTimeToTrackParameter(String parameter) {
        try {
    ...
    public static boolean checkDeclarationDataValidity(HttpServletRequest request, User user, String firstName,
